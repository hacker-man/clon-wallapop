angular.module("babelpop").controller("filterAdsCtrl", ["$scope", "$state", "$auth", "apiPaths", "APIClient", "userDataStorage", "checkAuth", "states", "errorHandler","filtcartego", function($scope, $state, $auth, apiPaths, APIClient, userDataStorage, checkAuth, states, errorHandler,filtcartego) {

    // Modelo de anuncios
    $scope.model = filtcartego.data;
