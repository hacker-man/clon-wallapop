angular.module("babelpop").controller("filterAdsNameCtrl", ["$scope", "$state", "$auth", "apiPaths", "APIClient",
    "userDataStorage", "checkAuth", "states", "errorHandler","filtername",function($scope, $state, $auth, apiPaths, APIClient, userDataStorage, checkAuth, states, errorHandler,filtername) {

    // Modelo de anuncios
    $scope.model = filtername.data;
